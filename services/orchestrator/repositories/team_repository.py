...
async def get_team_member_by_id(db: AsyncSession, member_id: UUID, organization: str) -> Optional[TeamMember]:
...
async def get_member_by_email_and_org(db: AsyncSession, email: str, organization: str) -> Optional[TeamMember]:
