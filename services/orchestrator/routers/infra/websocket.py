...
async def ws_pmc(
    ...
    """Real-time AI Agent communication for PMC users."""
        ...
        while True:
            ...
            if data.get("action") == "ping":
                ...
                if not sd.get("society_name"):
                    ...
                    continue
                task = asyncio.create_task(service.run_agent_ws(session_id, sd))
                service.mgr.tasks.add(task)
                task.add_done_callback(service.mgr.tasks.discard)
            else:
                await service.mgr.send(
...
async def ws_admin(
    ...
    """Real-time AI Agent communication for Admin users."""
