...
DEFAULT_SECTIONS = [
    {
        "section": "hero",
        "title": "AI-Powered Redevelopment Feasibility Reports",
        "subtitle": "Instant professional feasibility analysis for Mumbai housing society redevelopment",
    ...
    {
        "section": "features",
        "title": "Why Choose Dhara AI?",
        "subtitle": "Automated analysis powered by Mumbai's regulatory data",
        "content": "Automated Site Analysis|NOCAS Height Verification|DCPR 2034 Regulation Engine|Ready Reckoner Rate Integration|Professional Excel Reports|PR Card & DP Remark Extraction",
        "display_order": 2,
    },
    {
        "section": "how_it_works",
        "title": "How It Works",
        "content": "1. Enter society details|2. AI agent analyses regulations and financials|3. Download your professional feasibility report",
        "display_order": 3,
    },
    {
        "section": "cta",
        "title": "Ready to Transform Your Feasibility Analysis?",
...
class LandingService:
    ...
    async def submit_get_started(
        self, req: GetStartedRequestSchema, bg: BackgroundTasks
    ) -> FormSubmissionResponse:
        ...
        bg.add_task(
            ...
            req.name,
            req.email,
            req.message or f"Get Started from {req.name}",
            ref,
            "Get Started Request",
            req.phone,
        ...
        return FormSubmissionResponse(
            message="Thank you! We'll contact you within 24 hours.", reference_id=ref
        )

    async def submit_contact(
        self, req: ContactRequestSchema, bg: BackgroundTasks
    ) -> FormSubmissionResponse:
        ...
        return FormSubmissionResponse(
            message="Thank you! We'll respond within 1-2 business days.", reference_id=ref
        )
