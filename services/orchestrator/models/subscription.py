"""Subscription & Payment Models — Razorpay integration."""
...
PLANS = {
    "growth":     {"name": "Growth",       "amount_paise": 999900,  "currency": "INR", "period_days": 30, "description": "PMC Growth Plan - up to 10 societies"},
    "pro":        {"name": "Professional", "amount_paise": 2499900, "currency": "INR", "period_days": 30, "description": "PMC Pro Plan - up to 50 societies"},
    "enterprise": {"name": "Enterprise",   "amount_paise": 4999900, "currency": "INR", "period_days": 30, "description": "PMC Enterprise Plan - unlimited"},
}
...
class Subscription(Base, UUIDMixin, TimestampMixin):
    ...
    status: Mapped[SubscriptionStatus] = mapped_column(SAEnum(SubscriptionStatus, name="subscription_status", create_constraint=True), nullable=False, default=SubscriptionStatus.CREATED)
    ...
    __table_args__ = (Index("ix_subscriptions_user", "user_id"), Index("ix_subscriptions_status", "status"))
...
class Payment(Base, UUIDMixin, TimestampMixin):
    ...
    amount_paise: Mapped[int] = mapped_column(Integer, nullable=False)
    currency: Mapped[str] = mapped_column(String(3), nullable=False, default="INR")
    status: Mapped[PaymentStatus] = mapped_column(SAEnum(PaymentStatus, name="payment_status", create_constraint=True), nullable=False, default=PaymentStatus.CREATED)
    ...
    __table_args__ = (Index("ix_payments_user", "user_id"), Index("ix_payments_order", "razorpay_order_id"), Index("ix_payments_status", "status"))
...
class WebhookEvent(Base, UUIDMixin):
    ...
    __table_args__ = (Index("ix_webhook_event_type", "event_type"), Index("ix_webhook_processed", "processed"))
