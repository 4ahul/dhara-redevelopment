...
class TestPremiumService:
            ...
            "rates": [
                {
                    "category": "Land",
                    "value": "50000",
                    "previous_year_rate": "45000",
                    "increase_amount": "5000",
                    "increase_or_decrease_percent": "11.11",
                },
                {
                    "category": "Residential",
                    "value": "60000",
                    "previous_year_rate": "55000",
                    "increase_amount": "5000",
                    "increase_or_decrease_percent": "9.09",
                },
                {
                    "category": "Shop",
                    "value": "90000",
                    "previous_year_rate": "80000",
                    "increase_amount": "10000",
                    "increase_or_decrease_percent": "12.5",
                },
            ],
        }
    ...
    def test_calculate_premiums_open_land(self, mock_rr_repo):
        ...
        base_value_items = [
            item for item in result.line_items if "Property Base Value" in item.description
        ]
