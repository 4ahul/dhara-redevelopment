...
def generate_plot_map(
    rings: list,
    output_dir: str = "maps",
    setback_polys: list | None = None,
    max_road_polys: list | None = None,
    abutting_lines: list | None = None,
    ...
    margin_y = dy * 0.8
    ax.set_extent(
        [minx - margin_x, maxx + margin_x, miny - margin_y, maxy + margin_y],
    ...
    if metrics:
        ax.text(
            ...
            fontsize=10,
            color="white",
            bbox={"facecolor": "black", "alpha": 0.6, "boxstyle": "round,pad=0.3"},
        )
