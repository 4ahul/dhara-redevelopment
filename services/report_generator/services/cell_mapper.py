...
_DETAILS_33_12B: List[CellMapping] = [
    ...
    CellMapping("Details", "P46", "ready_reckoner.rr_residential_sqm|premium.rr_residential_sqm",  "float", 180000),
    CellMapping("Details", "Q46", "ready_reckoner.rr_open_land_sqm|premium.rr_open_land_sqm",      "float", 461400),
...
_PNL_33_12B: List[CellMapping] = [
    ...
    CellMapping("Profit & Loss Statement", "D21", "financial.sale_rate_commercial_2f",   "float", 0),
    CellMapping("Profit & Loss Statement", "D22", "financial.sale_rate_commercial_other","float", 0),
    CellMapping("Profit & Loss Statement", "D28", "financial.sale_rate_residential|sale_rate_per_sqft", "float", 100000),
    CellMapping("Profit & Loss Statement", "C30", "manual_inputs.parking_units_for_sale","int",   50),
    CellMapping("Profit & Loss Statement", "D30", "financial.parking_price_per_unit",    "float", 2500000),
]
...
_DETAILS_33_7A: List[CellMapping] = [
    ...
    CellMapping("Details", "O46", "manual_inputs.plot_road_length_m",            "float", 0),
    CellMapping("Details", "P46", "ready_reckoner.rr_residential_sqm|premium.rr_residential_sqm",  "float", 100000),
    CellMapping("Details", "Q46", "ready_reckoner.rr_open_land_sqm|premium.rr_open_land_sqm",      "float", 160160),
    ...
    CellMapping("Details", "J63", "ready_reckoner.rr_open_land_sqm|premium.rr_open_land_sqm", "float", 65180),
    CellMapping("Details", "O63", "manual_inputs.deposit_commercial",            "float", 0),
    CellMapping("Details", "Q63", "manual_inputs.deposit_residential",           "float", 0),
    CellMapping("Details", "O64", "manual_inputs.completion_months_commercial",  "float", 0),
...
_PNL_33_7A: List[CellMapping] = [
    CellMapping("Profit & Loss Statement", "D19", "financial.sale_rate_commercial_gf",   "float", 60000),
    CellMapping("Profit & Loss Statement", "C21", "manual_inputs.commercial_2f_area",    "float", 0),
    CellMapping("Profit & Loss Statement", "D22", "financial.sale_rate_commercial_other","float", 0),
    CellMapping("Profit & Loss Statement", "D28", "financial.sale_rate_residential|sale_rate_per_sqft", "float", 25000),
    CellMapping("Profit & Loss Statement", "C30", "manual_inputs.parking_units_for_sale","int",   25),
    CellMapping("Profit & Loss Statement", "D30", "financial.parking_price_per_unit",    "float", 1000000),
]
...
_DETAILS_INSITU: List[CellMapping] = [
    ...
    CellMapping("Details", "J66", "ready_reckoner.rr_open_land_sqm|premium.rr_open_land_sqm", "float", 58750),
...
_PNL_INSITU: List[CellMapping] = [
    CellMapping("Profit & Loss Statement", "D23", "financial.sale_rate_commercial_gf",   "float", 50000),
    CellMapping("Profit & Loss Statement", "D24", "financial.sale_rate_commercial_1f",   "float", 35000),
    ...
    CellMapping("Profit & Loss Statement", "D26", "financial.sale_rate_commercial_other","float", 30000),
    CellMapping("Profit & Loss Statement", "D36", "financial.sale_rate_residential|sale_rate_per_sqft", "float", 25000),
    CellMapping("Profit & Loss Statement", "C38", "manual_inputs.parking_units_for_sale","int",   250),
    CellMapping("Profit & Loss Statement", "D38", "financial.parking_price_per_unit",    "float", 1000000),
]
...
_DETAILS_2020B_CLUBBING: List[CellMapping] = [
    ...
    # ── RR Rates ──────────────────────────────────────────────────────────
    CellMapping("Details", "P44", "ready_reckoner.rr_residential_sqm|premium.rr_residential_sqm",  "float", 427590),
    CellMapping("Details", "Q44", "ready_reckoner.rr_open_land_sqm|premium.rr_open_land_sqm",      "float", 213130),
    CellMapping("Details", "J61", "ready_reckoner.rr_open_land_sqm|premium.rr_open_land_sqm", "float", 213130),
    ...
    CellMapping("Details", "P61", "financial.sale_rate_residential|sale_rate_per_sqft", "float", 65000),
    CellMapping("Details", "O61", "manual_inputs.deposit_commercial",            "float", 0),
    CellMapping("Details", "Q61", "manual_inputs.deposit_residential",           "float", 0),
...
_DETAILS_2020B_INSITU: List[CellMapping] = [
    ...
    CellMapping("Details", "J65", "ready_reckoner.rr_open_land_sqm|premium.rr_open_land_sqm", "float", 75910),
...
_DETAILS_33_12B_ONLY: List[CellMapping] = [
    ...
    CellMapping("Details", "J55", "ready_reckoner.rr_open_land_sqm|premium.rr_open_land_sqm", "float", 76180),
...
_PNL_33_12B_ONLY: List[CellMapping] = [
    ...
    CellMapping("Profit & Loss Statement", "D21", "financial.sale_rate_commercial_2f",   "float", 0),
    CellMapping("Profit & Loss Statement", "D22", "financial.sale_rate_commercial_other","float", 0),
    CellMapping("Profit & Loss Statement", "D28", "financial.sale_rate_residential|sale_rate_per_sqft", "float", 37000),
    CellMapping("Profit & Loss Statement", "C30", "manual_inputs.parking_units_for_sale","int",   50),
    CellMapping("Profit & Loss Statement", "D30", "financial.parking_price_per_unit",    "float", 1000000),
]
...
_DETAILS_33_19: List[CellMapping] = [
    ...
    CellMapping("Details", "J55", "ready_reckoner.rr_open_land_sqm|premium.rr_open_land_sqm", "float", 61580),
    CellMapping("Details", "O55", "manual_inputs.deposit_commercial",            "float", 0),
    CellMapping("Details", "Q55", "manual_inputs.deposit_residential",           "float", 0),
...
_PNL_33_19: List[CellMapping] = [
    ...
    CellMapping("Profit & Loss Statement", "D21", "financial.sale_rate_commercial_gf",   "float", 70000),
    CellMapping("Profit & Loss Statement", "C22", "manual_inputs.commercial_1f_area",    "float", 0),
    CellMapping("Profit & Loss Statement", "D22", "financial.sale_rate_commercial_1f",   "float", 45000),
    CellMapping("Profit & Loss Statement", "D23", "financial.sale_rate_commercial_other","float", 30000),
    CellMapping("Profit & Loss Statement", "D29", "financial.sale_rate_residential|sale_rate_per_sqft", "float", 24000),
    CellMapping("Profit & Loss Statement", "C31", "manual_inputs.parking_units_for_sale","int",   100),
    CellMapping("Profit & Loss Statement", "D31", "financial.parking_price_per_unit",    "float", 1000000),
]
...
_DETAILS_33_9: List[CellMapping] = [
    ...
    CellMapping("Details to be filled", "B8",  "manual_inputs.brokerage_residential",    "float", 45000),
    ...
    CellMapping("Details to be filled", "B10", "manual_inputs.completion_months_residential", "float", 72),
    CellMapping("Details to be filled", "C10", "manual_inputs.completion_months_commercial",  "float", 0),
    ...
    CellMapping("Details to be filled", "B46", "manual_inputs.construction_area_multiplier", "float", 1.2),
    ...
    CellMapping("Details to be filled", "C53", "manual_inputs.construction_area_multiplier_2", "float", 1.5),
...
_CONSTRUCTION_COST_33_9: List[CellMapping] = [
    ...
    CellMapping("Construction Cost", "D22", "manual_inputs.const_rate_podium_parking",     "float", 1700),
...
_PNL_33_9: List[CellMapping] = [
    CellMapping("Profit & Loss Statement", "C19", "manual_inputs.commercial_gf_area",   "float", 0),
    CellMapping("Profit & Loss Statement", "D19", "financial.sale_rate_commercial_gf",   "float", 150000),
    CellMapping("Profit & Loss Statement", "C20", "manual_inputs.commercial_1f_area",    "float", 0),
    CellMapping("Profit & Loss Statement", "D20", "financial.sale_rate_commercial_1f",   "float", 80000),
    CellMapping("Profit & Loss Statement", "C21", "manual_inputs.commercial_2f_area",    "float", 0),
    CellMapping("Profit & Loss Statement", "D21", "financial.sale_rate_commercial_2f",   "float", 40000),
    CellMapping("Profit & Loss Statement", "D22", "financial.sale_rate_commercial_other","float", 28000),
    CellMapping("Profit & Loss Statement", "C30", "manual_inputs.parking_units_for_sale","int",   400),
]
