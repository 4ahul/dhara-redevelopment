...
log_path = os.path.join(out_dir, "test_log3.txt")
...
async def run():
    ...
    try:
        ...
        captcha_path = os.path.join(out_dir, "captcha3.png")
        answer_path = os.path.join(out_dir, "answer3.txt")
        final_path = os.path.join(out_dir, "final_pr_card3.png")
        ...
        await page.screenshot(
            path=os.path.join(out_dir, "after_submit3.png"), full_page=True
        )
        logging.info("Saved after_submit3.png")
