...
log_path = os.path.join(out_dir, "test_log4.txt")
...
async def run():
    ...
    try:
        ...
        captcha_path = os.path.join(out_dir, "captcha4.png")
        answer_path = os.path.join(out_dir, "answer4.txt")
        final_path = os.path.join(out_dir, "final_pr_card4.png")
        ...
        await page.screenshot(
            path=os.path.join(out_dir, "after_submit4.png"), full_page=True
        )
        logging.info("Saved after_submit4.png")
