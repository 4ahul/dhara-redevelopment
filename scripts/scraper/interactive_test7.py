...
log_path = os.path.join(out_dir, "test_log7.txt")
...
async def run():
    ...
    try:
        ...
        captcha_path = os.path.join(out_dir, "captcha7.png")
        answer_path = os.path.join(out_dir, "answer7.txt")
        final_path = os.path.join(out_dir, "final_pr_card7.png")
        ...
        await page.screenshot(
            path=os.path.join(out_dir, "after_submit7.png"), full_page=True
        )
        logging.info("Saved after_submit7.png")
