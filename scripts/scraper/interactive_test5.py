...
log_path = os.path.join(out_dir, "test_log5.txt")
...
async def run():
    ...
    try:
        ...
        captcha_path = os.path.join(out_dir, "captcha5.png")
        answer_path = os.path.join(out_dir, "answer5.txt")
        final_path = os.path.join(out_dir, "final_pr_card5.png")
        ...
        await page.screenshot(
            path=os.path.join(out_dir, "after_submit5.png"), full_page=True
        )
        logging.info("Saved after_submit5.png")
