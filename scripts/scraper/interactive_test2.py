...
async def run():
    ...
    try:
        ...
        captcha_path = os.path.join(out_dir, "captcha2.png")
        answer_path = os.path.join(out_dir, "answer2.txt")
        final_path = os.path.join(out_dir, "final_pr_card.png")
        ...
        await page.screenshot(
            path=os.path.join(out_dir, "after_submit.png"), full_page=True
        )
        logging.info("Saved after_submit.png")
